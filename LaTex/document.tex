	...
	\begin{tikzpicture}
		\begin{axis}[
			barChart,
				...
				xticklabels from table = {data/lda_k_2_train.csv}{category},
			]
			\addplot table[x expr=\coordindex, y=hit] {data/lda_k_2_train.csv};
			\addplot table[x expr=\coordindex, y=miss] {data/lda_k_2_train.csv};
			\legend{Hit, Miss}
		\end{axis}
	\end{tikzpicture}
	\captionsetup{width=0.8\textwidth}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		\begin{axis}[
				...
				xticklabels from table = {data/lda_k_2_valid.csv}{category},
			]
			\addplot table[x expr=\coordindex, y=hit] {data/lda_k_2_valid.csv};
			\addplot table[x expr=\coordindex, y=miss] {data/lda_k_2_valid.csv};
			\legend{Hit, Miss}
		\end{axis}
	\end{tikzpicture}
	\captionsetup{width=0.8\textwidth}
...
\begin{figure}[H]
	...
	\begin{axis}[
				...
				xticklabels from table = {data/qda_k_2_train.csv}{category},
			]
			\addplot table[x expr=\coordindex, y=hit] {data/qda_k_2_train.csv};
			\addplot table[x expr=\coordindex, y=miss] {data/qda_k_2_train.csv};
			\legend{Hit, Miss}
		\end{axis}
		\end{tikzpicture}
	\captionsetup{width=0.8\textwidth}
	...
	\begin{tikzpicture}
		\begin{axis}[
			barChart,
				ymin = 0, ymax = 4200,
				restrict y to domain*=0:4600,
				xticklabels from table = {data/qda_k_2_valid.csv}{category},
			]
			\addplot table[x expr=\coordindex, y=hit] {data/qda_k_2_valid.csv};
			\addplot table[x expr=\coordindex, y=miss] {data/qda_k_2_valid.csv};
			\legend{Hit, Miss}
		\end{axis}
	\end{tikzpicture}
	\captionsetup{width=0.8\textwidth}
