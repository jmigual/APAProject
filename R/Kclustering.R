...
data = read.csv(choose.files(caption="Selecciona dades"), sep=" ", header = TRUE)
data$target = read.csv(choose.files(caption="Selecciona respostes"), sep=" ", header = FALSE)

for (i in 2:K){
  datatmp = read.csv(choose.files(caption="Selecciona dades"), sep=" ", header = TRUE)
  datatmp$target = i * read.csv(choose.files(caption="Selecciona respostes"), sep=" ", header = FALSE)
